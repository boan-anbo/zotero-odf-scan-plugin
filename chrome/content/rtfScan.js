...
var Zotero_RTFScan = new function() {
	...
	var localeService = Components.classes["@mozilla.org/intl/localeservice;1"]
		.getService(Components.interfaces.mozILocaleService);
	var appLocale = localeService.getAppLocaleAsLangTag();
	...
	this.chooseInputFile = function() {
		...
		if (inputPath) {
			if (!inputFile) {
				inputFile = Components.classes["@mozilla.org/file/local;1"].createInstance(Components.interfaces.nsIFile);
	...
	this.chooseOutputFile = function() {
		...
		if (outputPath) {
			if (!outputFile) {
				outputFile = Components.classes["@mozilla.org/file/local;1"].createInstance(Components.interfaces.nsIFile);
